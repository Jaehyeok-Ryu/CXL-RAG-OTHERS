...
# 메인 실행
def main(collection_name, dataset, rate, req_count, a=1.2, host="172.26.0.1", port=6333):
...
if __name__ == "__main__":
    ...
    main(args.collection_name, dataset, args.target_rps, args.requests_count, args.zipfian_alpha, args.host, args.port)
